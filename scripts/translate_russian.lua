...
local language_strings={
    ["HORNFIRE_NAME"] = "Огненный рог",
	["HORNFIRE_RECIPE_DESC"] = "Нет ничего общего с нормальным огнем.",
	["HORNFIRE_CHARACTERS_GENERIC_DESCRIBE"] = "Наконец поймал!",
	["HORNFIRE_CHARACTERS_WILLOW_DESCRIBE"] = "Они не могут улететь!",
	["HORNFIRE_CHARACTERS_WOLFGANG_DESCRIBE"] = "Меньше блеска!",
	["HORNFIRE_CHARACTERS_WENDY_DESCRIBE"] = "Мучительное сияние в темноте.",
	["HORNFIRE_CHARACTERS_WX78_DESCRIBE"] = "НЕГИГИЕНИЧЕСКИЕ БИОЛЮМИНЕСЦЕНТНЫЕ НАСЕКОМЫЕ",
